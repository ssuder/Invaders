...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Naciśnij spację", game.width / 2, game.height/2); 
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textBaseline="center"; 
    ctx.textAlign="center"; 
    ctx.fillText("Koniec gry!", game.width / 2, game.height/2 - 40); 
    ctx.font="16px Arial";
    ctx.fillText("Twój wynik to " + game.score + ", a poziom " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Naciśnij spację, żeby zagrać jeszcze raz", game.width / 2, game.height/2 + 40);   
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="14px Arial";
    ctx.fillStyle = '#ffffff';
    var info = "Życia: " + game.lives;
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.left, textYpos);
    info = "Wynik: " + game.score + ", Poziom: " + game.level;
    ctx.textAlign = "right";
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textBaseline="middle"; 
    ctx.textAlign="center"; 
    ctx.fillText("Poziom " + this.level, game.width / 2, game.height/2);
    ctx.font="24px Arial";
    ctx.fillText("Do startu " + this.countdownMessage, game.width / 2, game.height/2 + 36);      
    return;
};
